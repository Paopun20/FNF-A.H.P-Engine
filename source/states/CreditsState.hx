...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["AHP Engine Team"],
			["Paopun20", "missing_icon","Main developer of the AHP Engine, an adaptation of the Psych Engine framework.","https://www.youtube.com/channel/UCRrBz8jTU56TiXcmb9PtB4A",	"FFD700"],
			["Power By Psych Engine"],
			["original.Credits:Add('bruh');"],
	...
	override function update(elapsed:Float)
	{
		...
		if(!quitting)
		{
			...
			if(controls.ACCEPT && (creditsStuff[curSelected][3] != null || creditsStuff[curSelected][3].toString() != '' || creditsStuff[curSelected][3].toLowerCase() != '_nope')) {
				trace(creditsStuff[curSelected][3].toString());
				CoolUtil.browserLoad(creditsStuff[curSelected][3].toString());
			}
			if (controls.BACK)
			{
